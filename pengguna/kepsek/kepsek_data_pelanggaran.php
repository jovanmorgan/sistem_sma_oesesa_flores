...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Dashboard kepsek</a>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="pelanggaran/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="id_kepsek">kepsek:</label>
                                    <select class="form-control" id="id_kepsek" name="id_kepsek" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        include '../../keamanan/koneksi.php';

                                        // Query untuk mendapatkan data kepsek dan kepsek terkait
                                        ...
                                        if ($result) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['id_kepsek'] . "'>" . $row['nama'] . "</option>";
                                            }
                                            $result->free();
                                        } else {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="pelanggaran/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="editid_kepsek">kepsek:</label>
                                    <select class="form-control" id="editid_kepsek" name="id_kepsek" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        include '../../keamanan/koneksi.php';
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_pelanggaran, nama_pelanggaran, tanggal, id_siswa, id_sanksi, id_kepsek) {
                    ...
                    document.getElementById('editid_kepsek').value = id_kepsek;
