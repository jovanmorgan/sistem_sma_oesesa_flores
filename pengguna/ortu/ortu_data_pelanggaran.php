...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="pelanggaran/tambah.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <select class="form-control" id="id_ortu" name="id_ortu" required>
                                        ...
                                        if ($result) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['id_ortu'] . "'>" . $row['nama'] . "</option>";
                                            }
                                            $result->free();
                                        } else {
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="pelanggaran/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_pelanggaran" name="id_pelanggaran">
                                <div class="form-group">
                                    <label for="nama_pelanggaran">Nama pelanggaran:</label>
                                    <input type="text" class="form-control" id="editnama_pelanggaran" name="nama_pelanggaran" required>
                                </div>
                                <div class="form-group">
                                    <label for="tanggal">Tanggal :</label>
                                ...
                                <div class="form-group">
                                    <label for="editid_ortu">ortu:</label>
                                    <select class="form-control" id="editid_ortu" name="id_ortu" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        include '../../keamanan/koneksi.php';
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_pelanggaran, nama_pelanggaran, tanggal, id_siswa, id_sanksi, id_ortu) {
            ...
            <div class="content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    <!-- Tombol alat_export -->
                                                    <a href="pelanggaran/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            // Ambil id_siswa dari tabel ortu berdasarkan id_ortu
                                            $query_ortu = "SELECT id_siswa FROM ortu WHERE id_ortu = '$id_ortu'";
                                            $result_ortu = mysqli_query($koneksi, $query_ortu);

                                            if ($result_ortu && mysqli_num_rows($result_ortu) > 0) {
              ...
              WHERE pelanggaran.id_siswa = '$id_siswa'";
                                                ...
                                                if (!empty($search_query)) {
                                                    $query .= " AND (siswa.nama LIKE '%$search_query%' OR sanksi.sanksi LIKE '%$search_query%' OR guru.nama LIKE '%$search_query%' OR pelanggaran.nama_pelanggaran LIKE '%$search_query%' OR pelanggaran.tanggal LIKE '%$search_query%')";
                                                }
                                                ...
                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    ...
                                                    echo "<td class='text-center' colspan='7'><h3>Pelanggaran pada anak anda tidak ada</h3></td>";
                                                }
                                            } else {
                                                echo "<td class='text-center' colspan='7'><h3>Data siswa tidak ditemukan</h3></td>";
                                            }
