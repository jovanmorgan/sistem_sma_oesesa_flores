...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="sanksi/tambah.php" method="POST"
                                enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="sanksi">Nama sanksi:</label>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk mengedit data sanksi -->
                            <form id="form_edit" action="sanksi/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_sanksi" name="id_sanksi">
                                <div class="form-group">
                                    <label for="sanksi">Nama sanksi:</label>
            ...
            <!-- js edit -->
            <script>
            function openEditModal(id_sanksi, sanksi) {
                // Isi data ke dalam form edit
                document.getElementById('editid_sanksi').value = id_sanksi;
                document.getElementById('editsanksi').value = sanksi;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data sanksi</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="sanksi/export" target="_blank"
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class=" text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center column-fixed">Nama sanksi</th>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($search_query)) {
                                                $query .= " WHERE sanksi LIKE '%$search_query%'";
                                            }
                                            $query .= " ORDER BY id_sanksi DESC";
                                            $result = mysqli_query($koneksi, $query);
                                            $counter = 1;
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                ...
                                                                \"" . htmlspecialchars($row['sanksi'], ENT_QUOTES) . "\"
                                                            )'>Edit</button>
                                                        </td>";
                                                    echo "<td class='text-center'>
                                                            <button class='btn btn-danger btn-sm' onclick='hapus(\"" . htmlspecialchars($row['id_sanksi'], ENT_QUOTES) . "\")'>Hapus</button>
                                                        </td>";
                                                    echo "</tr>";
                                                    $counter++;
                                                }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'sanksi/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'sanksi/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'sanksi/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'sanksi/load_table.php', true);
        xhrTable.send();
    }
    </script>
