...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                            ...
                            <form id="form_tambah" action="siswa/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_kelas" name="id_kelas" required>
                                        ...
                                        // Query untuk mendapatkan data kelas dan jurusan terkait
                                        $query = "SELECT kelas.id_kelas, kelas.kelas, jurusan.jurusan 
                                      FROM kelas 
                                      JOIN jurusan ON kelas.id_jurusan = jurusan.id_jurusan";
                                        ...
                                        if ($result) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<option value='" . $row['id_kelas'] . "'>" . $row['kelas'] . " - " . $row['jurusan'] . "</option>";
                                            }
                                            $result->free();
                                        } else {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="siswa/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="editid_kelas">Kelas:</label>
            ...
            <script>
            function openEditModal(id_siswa, nama, username, password, nis, id_kelas, jk, tgl_lahir, agama, alamat) {
                    ...
                    <div class="col-md-12" translate="no">
                        <div class="card ">
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class=" text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center column-fixed">Jumlah Pelanggaran</th>
                            ...
                            SELECT siswa.*, 
                                   ...
                                   COUNT(pelanggaran.id_pelanggaran) AS jumlah_pelanggaran
                            FROM siswa
                        ...
                        ";
                                            ...
                                            if (!empty($search_query)) {
                                                $query .= " WHERE siswa.nama LIKE '%$search_query%' 
                                        OR siswa.username LIKE '%$search_query%' 
                                        OR siswa.password LIKE '%$search_query%' 
                                        OR siswa.nis LIKE '%$search_query%' 
                                        OR siswa.jk LIKE '%$search_query%' 
                                        OR siswa.tgl_lahir LIKE '%$search_query%' 
                                        OR siswa.agama LIKE '%$search_query%' 
                                        OR siswa.alamat LIKE '%$search_query%' 
                                        OR kelas.kelas LIKE '%$search_query%' 
                                        OR jurusan.jurusan LIKE '%$search_query%'";
                                            }

                                            $query .= " GROUP BY siswa.id_siswa ORDER BY siswa.id_siswa DESC";
                                            $result = mysqli_query($koneksi, $query);
                                            $counter = 1;
                                            ...
                                            if ($result) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    if ($row['jumlah_pelanggaran'] > 0) {
                                                        echo "<td class='text-center'>" . htmlspecialchars($row['jumlah_pelanggaran'], ENT_QUOTES) . "</td>";
                                                    } else {
                                                        echo "<td class='text-center'>Tidak ada pelanggaran</td>";
                                                    }
