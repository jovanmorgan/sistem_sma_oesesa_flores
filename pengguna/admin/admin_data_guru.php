...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="guru/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="edittempat_lahir">Tempat Lahir:</label>
                                ...
                                <div class="form-group">
                                    <label for="editno_hp">Nomor Hp :</label>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_guru, nama, username, password, nip, jk, tgl_lahir, tempat_lahir, jabatan, agama, alamat, no_hp) {
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data Guru BK</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="guru/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class=" text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center column-wide">Tempat Tanggal Lahir</th>
                                                <th class="text-center column-fixed">Jabatan</th>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($search_query)) {
                                                $query .= " WHERE nama LIKE '%$search_query%' OR username LIKE '%$search_query%' OR password LIKE '%$search_query%' OR nip LIKE '%$search_query%' OR jk LIKE '%$search_query%' OR tgl_lahir LIKE '%$search_query%' OR jabatan LIKE '%$search_query%' OR agama LIKE '%$search_query%' OR alamat LIKE '%$search_query%' OR no_hp LIKE '%$search_query%'";
                                            }
