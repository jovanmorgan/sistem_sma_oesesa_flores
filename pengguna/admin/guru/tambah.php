...
$tanggal_formatted = date('d-M-Y H:i', strtotime($tempat_lahir));
...
$query = "INSERT INTO guru (nama, username, password, nip, jk, tempat_lahir, tgl_lahir, jabatan, agama, alamat, no_hp) 
        VALUES ('$nama','$username', '$password', '$nip', '$jk', '$tempat_lahir', '$tanggal_formatted', '$jabatan', '$agama', '$alamat_data', '$no_hp')";
