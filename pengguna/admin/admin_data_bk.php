...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="bk/tambah.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_guru" name="id_guru" required>
                                        ...
                                        // Query untuk mendapatkan data guru dan guru terkait
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="hasil" name="hasil" required></textarea>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk mengedit data bk -->
                            <form id="form_edit" action="bk/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_bk" name="id_bk">
                                <div class="form-group">
                                    <label for="id_guru">Guru:</label>
                                ...
                                <div class="form-group">
                                    <label for="hasil">Hasil:</label>
                                    <textarea class="form-control" id="edithasil" name="hasil" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="tindakan">Tindakan:</label>
                                    <textarea class="form-control" id="edittindakan" name="tindakan"
                                        required></textarea>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_bk, hasil, tindakan, tanggal, id_siswa, id_guru) {
                    tindakan_data = tindakan.replace(/<br\s*\/?>/gi, '\n');
                    hasil_data = hasil.replace(/<br\s*\/?>/gi, '\n');
                    // Isi data ke dalam form edit
                    document.getElementById('editid_bk').value = id_bk;
                    document.getElementById('editid_guru').value = id_guru;
                    document.getElementById('editid_siswa').value = id_siswa;
                    document.getElementById('edittanggal').value = tanggal;
                    document.getElementById('edithasil').value = hasil_data;
                    document.getElementById('edittindakan').value = tindakan_data;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data BK</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="bk/export" target="_blank" class="btn btn-info btn-block"
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class=" text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center column-fixed">NIS</th>
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT bk.*, siswa.nama AS nama_siswa, siswa.nis AS nis, guru.nama AS nama_guru
                                            FROM bk
                                            LEFT JOIN siswa ON bk.id_siswa = siswa.id_siswa
                                            LEFT JOIN guru ON bk.id_guru = guru.id_guru";
                                            if (!empty($search_query)) {
                                                $query .= " WHERE siswa.nama LIKE '%$search_query%' OR siswa.nis LIKE '%$search_query%' OR guru.nama LIKE '%$search_query%' OR bk.hasil LIKE '%$search_query%' OR bk.tanggal LIKE '%$search_query%' OR bk.tindakan LIKE '%$search_query%'";
                                            }
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'bk/tambah.php', true);
                xhr.onload = function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'bk/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'bk/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'bk/load_table.php', true);
            xhrTable.send();
        }
    </script>
