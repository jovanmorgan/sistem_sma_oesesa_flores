...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="kelas/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_jurusan" name="id_jurusan" required>
                                        ...
                                        // Query untuk mendapatkan data jurusan dan jurusan terkait
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="kelas/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="editid_jurusan">jurusan:</label>
                                    <select class="form-control" id="editid_jurusan" name="id_jurusan" required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        include '../../keamanan/koneksi.php';
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_kelas, kelas, id_jurusan) {
                                        ...
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="kelas/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
