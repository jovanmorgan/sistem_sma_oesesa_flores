...
<head>
    ...
    <title>
        Bimbingan dan Konseling SMK Negeri 1 AESESA | guru Dashboard
    </title>
    <!--     Fonts and icons     -->
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <!-- pelanggaran -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./guru_data_pelanggaran'">
                            <div class="card-header">
                    ...
                    <!-- bk -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./guru_data_bk'">
                            <div class="card-header">
                    ...
                    <!-- sanksi -->
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./guru_data_sanksi'">
                            <div class="card-header">
