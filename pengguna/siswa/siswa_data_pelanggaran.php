...
// Jika pengguna sudah masuk, Anda dapat melanjutkan menampilkan halaman siswa.php seperti biasa
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="dark-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                            ...
                            <form id="form_tambah" action="pelanggaran/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_siswa" name="id_siswa" required>
                                        ...
                                        // Query untuk mendapatkan data siswa dan siswa terkait
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="pelanggaran/edit.php" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="editid_siswa">siswa:</label>
            ...
            <!-- js edit -->
            <script>
            function openEditModal(id_pelanggaran, nama_pelanggaran, tanggal, id_siswa, id_sanksi, id_siswa) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" translate="no">
                        ...
                        ";
                                            ...
                                            // Pastikan $id_siswa terdefinisi
                                            if (isset($id_siswa)) {
                                                $query .= " WHERE pelanggaran.id_siswa = '$id_siswa'";
                                            }

                                            if (!empty($search_query)) {
                                                $query .= " AND (siswa.nama LIKE '%$search_query%' 
                                          OR sanksi.sanksi LIKE '%$search_query%' 
                                          OR guru.nama LIKE '%$search_query%' 
                                          OR pelanggaran.nama_pelanggaran LIKE '%$search_query%' 
                                          OR pelanggaran.tanggal LIKE '%$search_query%')";
                                            }

                                            $query .= " ORDER BY pelanggaran.id_pelanggaran DESC";
                                            $result = mysqli_query($koneksi, $query);
                                            $counter = 1;
                                    ...
                                    <td class='text-center' colspan='5'>
                                        <h3>Pelanggaran anda tidak ada </br> Tetap Rajin Belajar dan jangan buat pelanggaran</h3>
                                    </td>
                                  </tr>";
                                            }
