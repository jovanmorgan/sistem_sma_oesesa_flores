            ...
            <div class="form-container">
                ...
                <form id="login" action="../keamanan/proses_login" method="POST">
                    ...
                    <div class="password-container">
                        ...
                        <i class="fa fa-eye-slash show-password" style="color: #000;" aria-hidden="true" onclick="togglePasswordVisibility('login-password')"></i>
                    </div>
                            ...
                            Swal.fire({
                                ...
                                switch (responseArray[2].trim()) {
                                    case "admin":
                                        ...
                                        break;
                                    case "guru":
                                        window.location.href = "../pengguna/guru/";
                                        break;
                                    case "kepsek":
                                        window.location.href = "../pengguna/kepsek/";
                                        break;
                                    case "ortu":
                                        window.location.href = "../pengguna/ortu/";
                                        break;
                                    case "siswa":
                                        window.location.href = "../pengguna/siswa/";
                                        break;
                                    default:
